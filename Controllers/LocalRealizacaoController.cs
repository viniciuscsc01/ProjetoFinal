...
namespace ProjetoFinal.Controllers
{
    public class LocalRealizacaoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("LocalRealizacaoId,LocalNome,CidadeId")] LocalRealizacao localRealizacao)
        {
            ...
            ViewData["CidadeId"] = new SelectList(_context.Cidade, "CidadeId", "CidadeId", localRealizacao.CidadeId);
            return View(localRealizacao);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("LocalRealizacaoId,LocalNome,CidadeId")] LocalRealizacao localRealizacao)
        {
