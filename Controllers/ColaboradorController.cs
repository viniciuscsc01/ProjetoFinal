...
namespace ProjetoFinal.Controllers
{
    public class ColaboradorController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["TipoColaboradorId"] = new SelectList(_context.TipoColaborador, "TipoColaboradorId", "TipoColaboradorId");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("ColaboradorId,ColaboradorNome,ColaboradorCpf,ColaboradorSexo,ColaboradorTelefone,CidadeId,TipoColaboradorId")] Colaborador colaborador)
        {
            ...
            ViewData["CidadeId"] = new SelectList(_context.Cidade, "CidadeId", "CidadeId", colaborador.CidadeId);
            ViewData["TipoColaboradorId"] = new SelectList(_context.TipoColaborador, "TipoColaboradorId", "TipoColaboradorId", colaborador.TipoColaboradorId);
            return View(colaborador);
        }
