...
namespace ProjetoFinal.Controllers
{
    public class ClienteController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ClienteId,ClienteNome,ClienteCpf,ClienteSexo,ClienteTelefone,ClienteEndereco,ClienteNumero,CidadeId")] Cliente cliente)
        {
