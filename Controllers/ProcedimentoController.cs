...
namespace ProjetoFinal.Controllers
{
    public class ProcedimentoController : Controller
    {
        ...
        {
            ViewData["TipoProcedimentoId"] = new SelectList(_context.TipoProcedimento, "Id", "Id");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("ProcedimentoId,ProcedimentoNome,ProcedimentoObservacaoId,TipoProcedimentoId")] Procedimento procedimento)
        {
            ...
            ViewData["TipoProcedimentoId"] = new SelectList(_context.TipoProcedimento, "Id", "Id", procedimento.TipoProcedimentoId);
            return View(procedimento);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProcedimentoId,ProcedimentoNome,ProcedimentoObservacaoId,TipoProcedimentoId")] Procedimento procedimento)
        {
